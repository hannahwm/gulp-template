...
//this is where you set variables (you also have to bind them in "bindElements"
  ...
  Neu.scrollmagicControls = {
      ...
      bindElements: function() {
        ...
        //this is where you bind the variables. self.$container just refers to the element that this script is called on (in this case ".wrapper", see the bottom of the script). self.options.pinned refers to the variable "pinned" which we set under options.
...
//This is where the function is initialized
(function init () {
